...
public  class CustomAdapter_List2 extends RecyclerView.Adapter<CustomAdapter_List2.CusromViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull CustomAdapter_List2.CusromViewHolder holder, int position) {
